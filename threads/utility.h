...
extern void DebugInit(char* flags, bool dprint);	// enable printing debug messages
...
extern bool DPrintIsEnabled(char flag);	

extern void DPRINT(char flag, char* format, ...);
